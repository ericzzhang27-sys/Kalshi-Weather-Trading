...
def _base_mapping_record(market: Mapping[str, Any]) -> dict[str, Any]:
    return {
        ...
        "last_price_dollars": _number_field(market, "last_price_dollars"),
        "previous_price_dollars": _number_field(market, "previous_price_dollars"),
        "yes_bid_dollars": _number_field(market, "yes_bid_dollars"),
        "yes_ask_dollars": _number_field(market, "yes_ask_dollars"),
        "no_bid_dollars": _number_field(market, "no_bid_dollars"),
        "no_ask_dollars": _number_field(market, "no_ask_dollars"),
