...
class Bucket:
    ...
    def __post_init__(self) -> None:
        ...
        if not isinstance(self.lower_bound, (int, float)) and self.lower_bound is not None:
            raise TypeError("lower_bound must be a number or None")

        if not isinstance(self.upper_bound, (int, float)) and self.upper_bound is not None:
            raise TypeError("upper_bound must be a number or None")
